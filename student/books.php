...
?>
	...
	<div style="background-color: #c80815; padding: 10px;width: 10%; height: 50px; float: left;">
	<h3 style="color: white; margin-top: 0px;">Trending:</h3>
	</div>
	<div style="background-color:#d0f0c0; width: 90%; height: 50px; float: left; padding: 10px;">
	<table>
		<?php
...
function closeNav() {
  ...
  document.body.style.backgroundColor = "white";
	...
	<!--_______________________request book___________________-->
	<div class="srch">
		<form class="navbar-form" method="post" name="form1">
